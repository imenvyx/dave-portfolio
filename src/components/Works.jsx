...
const Works = () => {
  return (
    <div id="works" className="">
      <div className="flex flex-col rounded-[64px] bg-[#3455DB]/20 backdrop-blur-lg p-16 max-w-[95%] backdrop-saturate-150 mx-auto">
        <div className="flex flex-col items-center">
          ...
          <div className="absolute right-[200px] -top-20">
            <img src={projectsImg} alt="" className="h-[300px] " />
          </div>
        </div>
        <div className=" top-20 grid grid-cols-9  lg:gap-14 ">
          {projects.map((proj, index) => (
            <motion.a
              key={`project-${index}`}
              className={`project1 cursor-pointer col-span-8 md:col-span-4 lg:col-span-3 max-h-[600px] h-[400px] lg:h-[500px] ${proj.color} xl:h-[600px] rounded-[64px]  backdrop-blur-lg backdrop-saturate-150 shadow-2xl  ${proj.hcolor} ease-out `}
            ...
            >
              ...
              >
                ...
                <p className="text-md lg:text-lg xl:text-xl text-[#220B38]/75 text-center">
                  {proj.description}
                </p>
